...
<div class="container" style="background-color: #e0ebeb;">
  ...
  <form >
        ...
        <div class="col-md-6 form-group" style="background-color: #f2f2f2; border-radius: 5px; padding: 20px;">
         ...
         <div class="form-group row">
            ...
            <div class="form-group">
                ...
                <input type="button" style="background-color: #ccccff;" class="form-control" id ="SaveOrUpdate" onclick="AddToOrder()" value="Add To Order">
                </div>
            </div>
        ...
        <div class="col-md-6 form-group" style="background-color: #ccccff; border-radius: 5px; padding: 20px;">
            ...
            <div class="form-group row">
             ...
             <div class="form-group">
              <div class="col-md-6"> 
                ...
                <input type="button" style="background-color: #ccccff;" class="form-control" id ="SaveOrUpdate" onclick="AddToOrder()" value="Save">
                </div>
                <div class="col-md-6"> 
       
                <input type="button" style="background-color: #ccccff;" class="form-control" id ="SaveOrUpdate" onclick="AddToOrder()" value="Close">
                </div>
            </div>
