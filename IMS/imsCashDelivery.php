...
<div class="form-group" >
  <div class="col-md-4" style="background-color:#e6ccff; border-radius: 2 px; padding: 44px;" >
     ...
     <label id="id">0</label>
      ...
      <label id="">Cash Delivery to Supplier</label>
    </div>
  ...
  <div class="col-md-8"  style="background-color: 	 #ccccff; border-radius: 3 px; padding: 20px;">
