...
<div class="form-group" >
 ...
 <div class="col-md-5"> 
    <span class="glyphicon glyphicon-earphone"> Customer</span>
    </div>
     <div class="col-md-7"> 
    <input type="text" class="form-control"  id="Name"   placeholder= "Kamal"   value=""><br>
    </div>
    ...
    <div class="form-group">
    <div class="col-md-5"> 
    <span class="glyphicon glyphicon-user"> Contact</span>
    </div>
     <div class="col-md-7"> 
    ...
    <input type="button" style="background-color:  #ccccff;" class="form-control" id ="SaveOrUpdate" onclick="myFunction()"  value="save">
    </div>
  ...
  <div class="col-md-8"  style="background-color:  #b3e6cc; border-radius: 3 px; padding: 20px;">
